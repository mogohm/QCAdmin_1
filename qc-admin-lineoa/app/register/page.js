  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ textAlign: "center", margin: "4px 0 4px" }}>
          สมัครขอเข้าใช้งาน
        </h2>
        <p
          style={{
        ...
        {msg && (
          <div style={{ color: "#22c55e", fontSize: 13, margin: "8px 0" }}>
            ✅ {msg}
          </div>
        )}
        {err && (
          <div style={{ color: "#ff8585", fontSize: 13, margin: "8px 0" }}>
            ⚠️ {err}
          </div>
        )}
