...
export default function SystemEvents() {
  ...
  const create = async () => {
    ...
    const r = await fetch("/api/system-events", {
      method: "POST",
  ...
  return (
    <AppShell
      title="System Events"
      subtitle="ช่วงระบบ/ธนาคารผิดปกติ → ยกเว้น SLA"
      actions={
        <span
          className="badge"
      ...
      <>
        ...
        <section className="grid split">
          <div className="card">
            ...
            <label style={lbl}>ชื่อ Event</label>
            <input
              value={form.title}
            ...
            <label style={lbl}>รายละเอียด / เหตุผล</label>
            <textarea
              rows={2}
            ...
            <div className="cols">
              ...
              <div>
                <label style={lbl}>สิ้นสุด (เว้นว่าง = ต่อเนื่อง)</label>
                <input
                  type="datetime-local"
                  value={form.ends_at}
