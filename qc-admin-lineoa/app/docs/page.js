...
start.bat          # รันปกติ
relogin.bat        # รัน + re-login อัตโนมัติเมื่อ session หมดอายุ
...
# event_type: register | kyc | deposit | withdrawal`)}
          ...
          <ol>
            ...
            <li>เปิด Dashboard ดู KPI (กรองตามวันที่ได้), Ranking admin, Reply log</li>
            <li>ดูส่วน <b>⏳ รอตอบ</b> — สีแดง = รอ &gt; 60 นาที, เหลือง = 30–60 นาที แสดง admin ที่รับผิดชอบ</li>
            <li>ใช้ช่องค้นหาใน Reply Log เพื่อกรองตามชื่อลูกค้าหรือ Admin, เรียงตาม Score/วันที่ได้</li>
