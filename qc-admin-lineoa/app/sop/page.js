...
export default function SOPManager() {
  ...
  const dup = (s) =>
    setEdit({
      ...
      id: null,
      topic: s.topic + " (copy)",
      keywords: joinKw(s.keywords),
      required_keywords: joinKw(s.required_keywords),
      forbidden_keywords: joinKw(s.forbidden_keywords),
    });
  const setActive = async (id, v) => {
      ...
      <>
        ...
        >
          ...
          <div className="card">
            ...
            <div className="kpi-value score good">{summary.active ?? 0}</div>
          </div>
          <div className="card">
            <div className="kpi-title">Escalation</div>
            <div className="kpi-value">{summary.escalation ?? 0}</div>
          </div>
          <div className="card">
                ...
                <tr key={s.id} style={{ opacity: s.is_active ? 1 : 0.5 }}>
                  ...
                  <td>
                    <span
                      className="badge"
                      style={{
                        background: s.used_count > 0 ? "#dcfce7" : "#f1f5f9",
                        color: s.used_count > 0 ? "#16a34a" : "#94a3b8",
                        fontSize: 10,
                      }}
                    >
                      {s.used_count || 0}
        ...
        {edit && (
          ...
          >
            ...
            >
              ...
              <TagEditor
                value={edit.forbidden_keywords}
                onChange={(v) => setEdit({ ...edit, forbidden_keywords: v })}
                placeholder="พิมพ์แล้ว Enter"
                color="#ef4444"
              />
              ...
              <TagEditor
                value={edit.keywords}
                onChange={(v) => setEdit({ ...edit, keywords: v })}
                placeholder="พิมพ์แล้ว Enter"
              />
